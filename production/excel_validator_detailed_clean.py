...
class ExcelValidatorDetailed:
    ...
    def _validate_worksheet_detailed(self, excel_file_path, sheet_name):
        ...
        # Hiển thị lỗi mẫu
        self._show_detailed_errors(df, sheet_name, col_c_name, col_d_name, col_t_name, col_k_name,
    ...
    def _report_detailed_stats(self, df, sheet_name, apply_array, apply_treatment, apply_fab_pipe=False):
        """
    ...
    def _show_detailed_errors(self, df, sheet_name, col_c_name, col_d_name, col_t_name, col_k_name,
                            apply_array_validation, apply_pipe_treatment_validation, apply_fab_pipe_validation):
        """

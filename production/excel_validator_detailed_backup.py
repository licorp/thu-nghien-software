...
class ExcelValidatorDetailed:
    ...
    def _report_detailed_stats(self, df, sheet_name, apply_array, apply_treatment, apply_fab_pipe, apply_pap):
        ...
        # Thống kê FAB Pipe
        if apply_fab_pipe:
            fab_pass = len(df[df['FAB_Pipe_Check'] == 'PASS'])
        ...
        if apply_pap:
            ...
            self.pap2_skip += pap2_skip    def _show_detailed_errors(self, df, sheet_name, col_c_name, col_d_name, col_t_name, col_k_name, col_o_name, col_p_name, 
